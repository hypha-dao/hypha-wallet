...
mixin _$TokensSettingsEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(SettingsTokenData token) addTokenToUser,
    required TResult Function(SettingsTokenData token) removeTokenToUser,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(SettingsTokenData token)? addTokenToUser,
    TResult? Function(SettingsTokenData token)? removeTokenToUser,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
...
abstract class _$$_AddTokenToUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({SettingsTokenData token});
}
...
abstract class _AddTokenToUser implements TokensSettingsEvent {
  const factory _AddTokenToUser(final SettingsTokenData token) =
      _$_AddTokenToUser;

  SettingsTokenData get token;
  @JsonKey(ignore: true)
  _$$_AddTokenToUserCopyWith<_$_AddTokenToUser> get copyWith =>
      throw _privateConstructorUsedError;
}
...
abstract class _RemoveTokenToUser implements TokensSettingsEvent {
  const factory _RemoveTokenToUser(final SettingsTokenData token) =
...
mixin _$TokensSettingsState {
  ...
  List<SettingsTokenData> get tokens => throw _privateConstructorUsedError;
...
class _$_TokensSettingsState extends _TokensSettingsState {
  const _$_TokensSettingsState(
      ...
      this.command,
      final List<SettingsTokenData> tokens = const []})
      : _tokens = tokens,
        super._();
  ...
  final List<SettingsTokenData> _tokens;
  @override
  @JsonKey()
  List<SettingsTokenData> get tokens {
...
abstract class _TokensSettingsState extends TokensSettingsState {
  const factory _TokensSettingsState(
      {final PageState pageState,
      final PageCommand? command,
      final List<SettingsTokenData> tokens}) = _$_TokensSettingsState;
