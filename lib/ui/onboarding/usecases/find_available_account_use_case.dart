...
class FindAvailableAccountUseCase extends InputUseCase<Result<String, HyphaError>, CheckAccountInput> {
  final UserAccountRepository _userAccountRepository;

  FindAvailableAccountUseCase(this._userAccountRepository);

  @override
  Future<Result<String, HyphaError>> run(CheckAccountInput input) async {
    try {
      final result = await _userAccountRepository.findAvailableUserAccount(input.accountName, input.network);
