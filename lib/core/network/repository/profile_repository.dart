...
class ProfileService {
  ...
  Future<Result<ProfileData, HyphaError>> getProfile(UserProfileData user, Network network) async {
    final url =
        '${_remoteConfigService.profileServiceEndpoint}${Endpoints.pppProfile}/${user.accountName}?network=${network.name}';
    try {
