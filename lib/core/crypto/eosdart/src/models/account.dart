...
class RequiredAuth {
  ...
  factory RequiredAuth.fromJson(Map<String, dynamic> json) => _$RequiredAuthFromJson(json);
...
class TotalResources with ConversionHelper {
  ...
  factory TotalResources.fromJson(Map<String, dynamic> json) => _$TotalResourcesFromJson(json);
...
class SelfDelegatedBandwidth {
  ...
  factory SelfDelegatedBandwidth.fromJson(Map<String, dynamic> json) => _$SelfDelegatedBandwidthFromJson(json);
...
class VoterInfo with ConversionHelper {
  ...
  factory VoterInfo.fromJson(Map<String, dynamic> json) => _$VoterInfoFromJson(json);
